...
void subwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (subwindow::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&subwindow::mySignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void subwindow::mySignal(QString _t1)
{
