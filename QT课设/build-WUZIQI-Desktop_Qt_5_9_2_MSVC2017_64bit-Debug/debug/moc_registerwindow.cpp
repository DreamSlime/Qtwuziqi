...
#include "../../WUZIQI/registerwindow.h"
...
QT_MOC_LITERAL(1, 15, 11), // "regitSignal"
QT_MOC_LITERAL(2, 27, 0) // ""

    },
    "registerwindow\0regitSignal\0"
};
...
void registerwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&registerwindow::regitSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void registerwindow::regitSignal()
{
